...
privileged aspect SesongController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> SesongController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Sesong sesong = Sesong.fromJsonToSesong(json);
    ...
    public ResponseEntity<String> SesongController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (Sesong sesong: Sesong.fromJsonArrayToSesongs(json)) {
            if (sesong.merge() == null) {
